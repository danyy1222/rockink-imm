      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {!isAdmin && (
              <>
                <Link href="/cart">
                  <Button size="sm" className="relative bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-4 py-2 transition-all duration-200 font-semibold shadow-sm hover:shadow-md">
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden mt-4 pt-4 pb-2 border-t border-primary/20 flex flex-col gap-2">
            {!isAdmin && (
              <>
                <Link href="/" className="py-2 px-3 hover:bg-primary/50 rounded-lg transition-colors duration-200 text-sm font-medium">
                  Inicio
                </Link>
                <Link href="/#products" className="py-2 px-3 hover:bg-primary/50 rounded-lg transition-colors duration-200 text-sm font-medium">
                  Tienda
                </Link>
            ...
            {isAdmin && (
              <>
                <Link href="/admin" className="py-2 px-3 hover:bg-primary/50 rounded-lg transition-colors duration-200 text-sm font-medium">
                  Panel
                </Link>
                <Link href="/admin/productos" className="py-2 px-3 hover:bg-primary/50 rounded-lg transition-colors duration-200 text-sm font-medium">
                  Gestionar
                </Link>
              </>
            )}
